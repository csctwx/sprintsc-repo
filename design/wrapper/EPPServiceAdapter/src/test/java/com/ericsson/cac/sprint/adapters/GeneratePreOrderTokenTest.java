...
public class GeneratePreOrderTokenTest {
    ...
    @Test
    public void testGeneratePreOrderToken() throws DatatypeConfigurationException, JAXBException, Faultmessage, TransformerFactoryConfigurationError, TransformerException, com.sprint.integration.eai.services.enterprisewalletservice.v1.enterprisewalletservice.Faultmessage {
...
//      AuthorizePaymentRequest authorizePayment = new AuthorizePaymentRequest();
      ...
      token.setExternalOrderId("KHK_TEST_ORDER_001");
      ...
      CardSensitiveDetails details = new CardSensitiveDetails();
		...
		GeneratePreOrderTokenResponse generatePreOrderTokenResponse;
		try {
			generatePreOrderTokenResponse = service.generatePreOrderToken(null, request, details);
