...
public class CancelAuthorizePaymentTest {
    ...
    @Test
    public void testCancelAuthorizePayment() throws DatatypeConfigurationException, JAXBException, Faultmessage, TransformerFactoryConfigurationError, TransformerException, com.sprint.integration.eai.services.enterprisewalletservice.v1.enterprisewalletservice.Faultmessage {
		...
		request.setPaymentId("zsAFXlL8SUZYs7Ou8gSTKk2ay7DDwG0ot7zp");

		CancelAuthorizePaymentResponse cancelAuthorizePaymentResponse;
		try {
			cancelAuthorizePaymentResponse = service.cancelAuthorizePayment(null, request);
