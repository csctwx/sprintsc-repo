...
public class AuthorizePaymentTest {
    ...
    @Test
    public void testAuthorizePayment() throws DatatypeConfigurationException, JAXBException, Faultmessage, TransformerFactoryConfigurationError, TransformerException, com.sprint.integration.eai.services.enterprisewalletservice.v1.enterprisewalletservice.Faultmessage, IOException {
    	AuthorizePaymentRequest request= new AuthorizePaymentRequest();

		request.setExternalOrderId("KHK_TEST_ORDER_996");
		...
		info.setSourceTransactionId("TOP_249597750_1425924217475");
		...
		AuthorizePaymentResponse authorizePaymentResponse = service.authorizePayment(null, request, details);
