...
@Component
@Aspect
public class EnterprisePaymentServiceLogging {
	
	private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(EnterprisePaymentServiceLogging.class);
    
    @Before("execution(* com.ericsson.cac.sprint.adapters.EnterprisePaymentProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.EnterprisePaymentProxyService.*(..))",
            returning= "result")
