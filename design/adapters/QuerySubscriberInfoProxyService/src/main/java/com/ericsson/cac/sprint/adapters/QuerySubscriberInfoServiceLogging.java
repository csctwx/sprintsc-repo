...
@Component
@Aspect
public class QuerySubscriberInfoServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QuerySubscriberInfoServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QuerySubscriberInfoProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QuerySubscriberInfoProxyService.*(..))",
            returning= "result")
