...
@Component
@Aspect
public class AccountManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(AccountManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.AccountManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.AccountManagementProxyService.*(..))",
            returning= "result")
