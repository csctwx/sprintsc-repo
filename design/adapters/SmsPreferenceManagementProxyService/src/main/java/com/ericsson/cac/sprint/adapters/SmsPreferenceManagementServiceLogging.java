...
@Component
@Aspect
public class SmsPreferenceManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(SmsPreferenceManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.SmsPreferenceManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.SmsPreferenceManagementProxyService.*(..))",
            returning= "result")
