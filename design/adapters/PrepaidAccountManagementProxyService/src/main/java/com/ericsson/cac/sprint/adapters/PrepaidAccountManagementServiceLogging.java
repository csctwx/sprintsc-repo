...
@Component
@Aspect
public class PrepaidAccountManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(PrepaidAccountManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.PrepaidAccountManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.PrepaidAccountManagementProxyService.*(..))",
            returning= "result")
