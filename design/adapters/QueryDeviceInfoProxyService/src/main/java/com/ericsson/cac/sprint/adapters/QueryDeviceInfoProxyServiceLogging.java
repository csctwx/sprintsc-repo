...
@Component
@Aspect
public class QueryDeviceInfoProxyServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryDeviceInfoProxyServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryDeviceInfoProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryDeviceInfoProxyService.*(..))",
            returning= "result")
