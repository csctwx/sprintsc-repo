...
@Component
@Aspect
public class OrderFulfillmentServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(OrderFulfillmentServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.OrderFulfillmentProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.OrderFulfillmentProxyService.*(..))",
            returning= "result")
