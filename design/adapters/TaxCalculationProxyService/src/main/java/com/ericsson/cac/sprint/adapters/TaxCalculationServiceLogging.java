...
@Component
@Aspect
public class TaxCalculationServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(TaxCalculationServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.TaxCalculationProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.TaxCalculationProxyService.*(..))",
            returning= "result")
