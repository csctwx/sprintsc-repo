...
@Component
@Aspect
public class QueryOrderFulfillmentServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryOrderFulfillmentServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryOrderFulfillmentProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryOrderFulfillmentProxyService.*(..))",
            returning= "result")
