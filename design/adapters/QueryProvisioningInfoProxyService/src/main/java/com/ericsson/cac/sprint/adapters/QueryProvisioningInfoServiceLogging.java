...
@Component
@Aspect
public class QueryProvisioningInfoServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryProvisioningInfoServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryProvisioningInfoProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryProvisioningInfoProxyService.*(..))",
            returning= "result")
