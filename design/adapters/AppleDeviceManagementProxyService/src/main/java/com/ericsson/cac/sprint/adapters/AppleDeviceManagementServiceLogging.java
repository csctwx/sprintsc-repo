...
@Component
@Aspect
public class AppleDeviceManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(AppleDeviceManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.AppleDeviceManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.AppleDeviceManagementProxyService.*(..))",
            returning= "result")
