...
@Component
@Aspect
public class PromotionManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(PromotionManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.PromotionManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.PromotionManagementProxyService.*(..))",
            returning= "result")
