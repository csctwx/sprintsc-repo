...
@Component
@Aspect
public class VoucherManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(VoucherManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.VoucherManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.VoucherManagementProxyService.*(..))",
            returning= "result")
