...
@Component
@Aspect
public class OfferManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(OfferManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.OfferManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.OfferManagementProxyService.*(..))",
            returning= "result")
