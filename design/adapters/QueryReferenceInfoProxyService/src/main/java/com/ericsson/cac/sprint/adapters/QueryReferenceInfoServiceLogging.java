...
@Component
@Aspect
public class QueryReferenceInfoServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryReferenceInfoServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryReferenceInfoProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryReferenceInfoProxyService.*(..))",
            returning= "result")
