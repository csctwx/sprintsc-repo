...
@Component
@Aspect
public class CustomerDataPrivacyManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(CustomerDataPrivacyManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.CustomerDataPrivacyManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.CustomerDataPrivacyManagementProxyService.*(..))",
            returning= "result")
