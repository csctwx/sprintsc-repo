...
@Component
@Aspect
public class QueryPlansAndOptionsLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryPlansAndOptionsLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryPlansAndOptionsProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryPlansAndOptionsProxyService.*(..))",
            returning= "result")
