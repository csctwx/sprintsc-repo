...
@Component
@Aspect
public class SecurityManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(SecurityManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.SecurityManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.SecurityManagementProxyService.*(..))",
            returning= "result")
