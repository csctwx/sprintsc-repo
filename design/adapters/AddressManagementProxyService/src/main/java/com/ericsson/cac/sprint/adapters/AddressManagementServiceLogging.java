...
@Component
@Aspect
public class AddressManagementServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(AddressManagementServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.AddressManagementProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.AddressManagementProxyService.*(..))",
            returning= "result")
