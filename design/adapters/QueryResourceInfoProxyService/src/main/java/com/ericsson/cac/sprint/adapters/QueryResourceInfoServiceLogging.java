...
@Component
@Aspect
public class QueryResourceInfoServiceLogging {
    private static Gson gson = new Gson();
    private Logger logger = LoggerFactory.getLogger(QueryResourceInfoServiceLogging.class);

    @Before("execution(* com.ericsson.cac.sprint.adapters.QueryResourceInfoProxyService.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.ericsson.cac.sprint.adapters.QueryResourceInfoProxyService.*(..))",
            returning= "result")
