	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div>
				...
				<c:forEach var="history" items="${textHistory}" varStatus="status">
					<div class="row">
				...
				<nav class="navbar navbar-default navbar-fixed-bottom">
					<div class="container">
						<ul class="nav navbar-nav">
							<li>
								<a href="portal:usage-talk-history" class="btn btn-default col-xs-6">Talk History</a>
							</li>
							<li>
								<a href="portal:usage-text-history" class="btn btn-primary col-xs-6">Text History</a>
							</li>
						</ul>
					</div>
				</nav>
